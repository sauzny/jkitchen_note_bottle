...
public class ProductVO {
    ...
    public String toString() {
        return "ProductVO [id=" + id + ", createTime=" + createTime + ", lastUpdateTime=" + lastUpdateTime + ", name=" + name + ", supplierId="
                + supplierId + ", supplierName=" + supplierName + ", supplierProductNo=" + supplierProductNo + ", purchasePrice=" + purchasePrice
                + ", minDistribution=" + minDistribution + ", maxDistribution=" + maxDistribution + ", state=" + state + "]";
    }
